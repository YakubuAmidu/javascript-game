...
class Raven {
    constructor(){
        ...
        this.colors = 'rgb(' + this.randomColors[0] + ',' + this.randomColors[1] + ',' + this.randomColors[2] + ')';
    };
    ...
    draw(){
        collisionCtx.fillStyle = this.colors;
...
function drawGameOver(){
    ...
    ctx.fillStyle = 'black';
    ctx.fillText('Game Over, your score is: ' + score, canvas.width / 2, canvas.
    height / 2);
    ctx.fillStyle = 'white';
